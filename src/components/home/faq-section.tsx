...
function FAQItem({
  ...
  return (
    <div className="border-b border-gray-100 last:border-b-0">
      ...
      >
        <span className="text-[#111827] font-semibold text-[15px] group-hover:text-[#60A5FA] transition-colors leading-snug">
          {question}
        </span>
        <span className="shrink-0 w-6 h-6 rounded-full border border-gray-200 flex items-center justify-center text-[#6b7280] mt-0.5 group-hover:border-[#60A5FA] group-hover:text-[#60A5FA] transition-colors">
