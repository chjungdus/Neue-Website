            ...
            <div className="p-10 md:p-14">
              <FadeIn>
                ...
                <p className="text-slate-400 text-lg mb-5 max-w-lg leading-relaxed">
                  Wir hören zu und sagen Ihnen ehrlich, ob und wie wir helfen können. Wenn wir nicht die richtige Agentur für Ihr Projekt sind — sagen wir das auch.
                </p>
                <p className="text-slate-600 text-sm mb-10 max-w-md leading-relaxed">
                  Nicht zufrieden mit dem ersten Design-Entwurf? Wir überarbeiten kostenlos, ohne Diskussion, so lange bis es passt.
                </p>
                <div className="flex flex-col sm:flex-row items-start gap-3">
                  ...
                  <Link href="/kontakt" className="flex items-center gap-2 text-slate-400 font-semibold px-8 py-4 rounded-full border border-slate-700 hover:border-slate-500 hover:text-white transition-all text-[15px]">
                    Erst mal schreiben
                  </Link>
                </div>
              </FadeIn>
            ...
            <div className="p-10 md:p-14 flex flex-col justify-center gap-6">
              <FadeIn direction="right">
                <div className="flex flex-col gap-5">
                  <a href="https://wa.me/4917680257270" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3.5 text-slate-400 hover:text-white transition-colors group">
                    <span className="w-9 h-9 rounded-xl bg-slate-800 flex items-center justify-center flex-shrink-0 group-hover:bg-[#2563eb] transition-colors">
                      <Phone size={15} className="text-slate-500 group-hover:text-white transition-colors" />
                    </span>
                    <span className="text-sm font-medium">+49 176 8025 7270</span>
                  </a>
                  <a href="mailto:mateo.sdlm@gmail.com" className="flex items-center gap-3.5 text-slate-400 hover:text-white transition-colors group">
                    <span className="w-9 h-9 rounded-xl bg-slate-800 flex items-center justify-center flex-shrink-0 group-hover:bg-[#2563eb] transition-colors">
                      <Mail size={15} className="text-slate-500 group-hover:text-white transition-colors" />
                    </span>
                ...
                <div className="mt-8 pt-6 border-t border-slate-800">
                  <p className="text-slate-700 text-xs leading-relaxed">Antwort innerhalb von 24 Stunden<br />Erstgespräch kostenlos & unverbindlich</p>
                </div>
              </FadeIn>
            </div>
          </div>
