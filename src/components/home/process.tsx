...
const steps = [
  ...
  },
  {
    ...
    body: "Wir präsentieren den vollständigen Design-Entwurf. Sie geben Feedback — wir passen an. Dieser Prozess wiederholt sich, bis es wirklich passt. Keine versteckten Kosten für Korrekturunden. Kein \"das kostet extra\".",
