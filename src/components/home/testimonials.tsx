        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 items-start">
          {testimonials.map((t, i) => (
            <FadeIn key={t.name} delay={i * 0.12} className={i === 1 ? "md:mt-10" : ""}>
              <div className="relative bg-white border border-[#0a0a0f]/[0.08] shadow-sm rounded-2xl p-8">
                ...
                <p className="text-[#0a0a0f] text-xl md:text-2xl font-medium leading-relaxed mb-7">
                  &bdquo;{t.quote}&ldquo;
                </p>

                <div className="flex items-center justify-between flex-wrap gap-4 pt-5 border-t border-[#0a0a0f]/[0.08]">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-[#0a0a0f]/50 text-xs mt-0.5">{t.meta}</div>
                    </div>
                  </div>
