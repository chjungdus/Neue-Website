    ...
    return (
      <div className="border border-[#10b981]/30 bg-[#f0fdf4] rounded-2xl p-10 text-center">
        ...
        <button
          ...
          className="mt-6 text-[#2563eb] text-sm hover:underline transition-colors"
        >
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
      ...
      <button
        ...
        className="bg-[#2563eb] hover:bg-[#1d4ed8] text-white font-semibold px-6 py-4 rounded-full transition-colors disabled:opacity-60 flex items-center justify-center gap-2"
      >
        {status === "loading" ? (
